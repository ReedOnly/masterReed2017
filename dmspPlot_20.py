...
f ='./files/dmsp/rfe20_PS.APL_V0116S024CE0008_SC.U_DI.A_GP.F17-SSUSI_PA.APL-SDR-DISK_DD.20141203_SN.41684-00_DF.NC' #my file
...
title = 'RFE:20 DMSP F17 and SuperDARN 03.12.2014 11:12'
...
##Swarm-B
latSwarm,lonSwarm,timeSwarm=satorbit('./files/orbits/20_SW-B.txt')
...
##NOAA-19
lat2,lon2,time2=satorbit('./files/orbits/20_NOAA-19.txt')
...
#Add SuperDARN Scan
#===================================================
sTime=dt.datetime(2014, 12, 3, 11, 12)
...
plt.savefig('./dmsp20_nosd.png', dpi=600)
