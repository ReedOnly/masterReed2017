...
f ='./files/dmsp/rfe2_PS.APL_V0116S024CE0018_SC.U_DI.A_GP.F16-SSUSI_PA.APL-SDR-DISK_DD.20141216_SN.57583-00_DF.NC' #my file
...
title = 'SuperDARN 16 December 2014 00:38 UT'
...
#Add satellite track
map_.plot(sc_lon, sc_lat, latlon=True, coords='geo', color='b',
...
##Swarm
latSwarm,lonSwarm,timeSwarm=satorbit('./files/orbits/2_SW-A.txt')
...
##Meteop 2A
lat2,lon2,time2=satorbit('./files/orbits/2_Meteop-A.txt')
