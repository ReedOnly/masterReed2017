...
f ='./files/dmsp/rfe24_PS.APL_V0116S024CB0005_SC.U_DI.A_GP.F18-SSUSI_PA.APL-SDR-DISK_DD.20141204_SN.26442-00_DF.NC' #my file
...
##Swarm-B
latSwarm,lonSwarm,timeSwarm=satorbit('./files/orbits/24_SW-B.txt')
...
plt.savefig('./dmsp24.png', dpi=600)
