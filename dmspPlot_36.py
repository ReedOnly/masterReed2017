...
map_date_ = dt.datetime(2014, 12, 1, 15, 47)

f ='./files/dmsp/rfe36_PS.APL_V0116S024CE0018_SC.U_DI.A_GP.F16-SSUSI_PA.APL-SDR-DISK_DD.20141201_SN.57380-00_DF.NC' #my file
#f ='./files/dmsp/rfe36_PS.APL_V0116S024CE0018_SC.U_DI.A_GP.F16-SSUSI_PA.APL-SDR-DISK_DD.20141201_SN.57379-00_DF.NC' #my file
...
title = 'RFE:36, DMSP F16 and SuperDARN "inv" 01.12.2014 15:47'
...
##NOAA-19
lat2,lon2,time2=satorbit('./files/orbits/36_MO-A.txt')
...
#Add SuperDARN Scan
#===================================================
sTime=dt.datetime(2014, 12, 1, 15, 54)
data = pydarn.sdio.radDataRead.radDataOpen(sTime, 'ksr', eTime=sTime+dt.timedelta(seconds=120))
...
plt.savefig('./dmsp36_ksr.png', dpi=600)
