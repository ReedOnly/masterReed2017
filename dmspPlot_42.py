...
map_date_ = dt.datetime(2014, 12, 04, 18, 46)

#f ='./files/dmsp/rfe21_PS.APL_V0116S024CE0008_SC.U_DI.A_GP.F17-SSUSI_PA.APL-SDR-DISK_DD.20141203_SN.41685-00_DF.NC' #my file
f ='./files/dmsp/rfe42_PS.APL_V0116S024CE0018_SC.U_DI.A_GP.F16-SSUSI_PA.APL-SDR-DISK_DD.20141204_SN.57424-00_DF.NC' #my file
...
title = 'RFE:42 DMSP F16 and SuperDARN 04.12.2014 18:46'
...
#Add SuperDARN Scan
#===================================================
sTime=dt.datetime(2014, 12, 04, 18, 46)
...
plt.savefig('./dmsp42.png', dpi=600)
