...
map_date_ = dt.datetime(2014, 12, 20, 17, 26)

#f ='./files/dmsp/rfe19_PS.APL_V0116S024CB0005_SC.U_DI.A_GP.F18-SSUSI_PA.APL-SDR-DISK_DD.20141220_SN.26672-00_DF.NC' #my file
f ='./files/dmsp/rfe19_PS.APL_V0116S024CE0008_SC.U_DI.A_GP.F17-SSUSI_PA.APL-SDR-DISK_DD.20141220_SN.41929-00_DF.NC' #my file
...
title = 'DMSP F17 and SuperDARN 20.12.2014 17:26'
...
sc_time = [dt.datetime(2014, 12, 20) + dt.timedelta(seconds=x) for x in fh.variables['DMSP_COORDS_TIME'].data.ravel()]
...
#Add SuperDARN Scan
#===================================================
sTime=dt.datetime(2014, 12, 20, 17, 26)
...
plt.savefig('./dmsp19_f17.png', dpi=600)
