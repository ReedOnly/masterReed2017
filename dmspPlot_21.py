...
map_date_ = dt.datetime(2014, 12, 03, 12, 32)

#f ='./files/dmsp/rfe21_PS.APL_V0116S024CE0008_SC.U_DI.A_GP.F17-SSUSI_PA.APL-SDR-DISK_DD.20141203_SN.41685-00_DF.NC' #my file
f ='./files/dmsp/rfe21_PS.APL_V0116S024CB0005_SC.U_DI.A_GP.F18-SSUSI_PA.APL-SDR-DISK_DD.20141203_SN.26429-00_DF.NC' #my file
...
title = 'RFE:21 DMSP F18 and SuperDARN 03.12.2014 12:34'
...
##Swarm-B
latSwarm,lonSwarm,timeSwarm=satorbit('./files/orbits/21_SW-B.txt')
...
##NOAA-19
lat2,lon2,time2=satorbit('./files/orbits/21_NOAA-19.txt')
...
#Add SuperDARN Scan
#===================================================
sTime=dt.datetime(2014, 12, 03, 12, 34)
...
plt.savefig('./dmsp21_f18.png', dpi=600)
