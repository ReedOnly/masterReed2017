...
f ='./files/dmsp/rfe28_PS.APL_V0116S024CE0008_SC.U_DI.A_GP.F17-SSUSI_PA.APL-SDR-DISK_DD.20141213_SN.41820-00_DF.NC' #my file
...
title = 'RFE 28: DMSP F17 and SuperDARN 13 Dec 2014 at 00:19 UT'
...
#Add SuperDARN Scan
#================================================cly===
sTime=dt.datetime(2014, 12, 13, 0, 19)
...
intensities,pcoll=pydarn.plotting.fan.overlayFan(scan, map_, fig, 'velocity', coords='mag', gsct=False, site=None,
               ...
               norm=plt.Normalize(vmin=-500, vmax=500), alpha=0.6)
...
plt.savefig('./dmsp28_inv19.pdf', dpi=200)