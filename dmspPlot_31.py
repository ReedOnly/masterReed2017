...
map_date_ = dt.datetime(2014, 12, 17, 21, 11)

f ='./files/dmsp/rfe31_PS.APL_V0116S024CB0005_SC.U_DI.A_GP.F18-SSUSI_PA.APL-SDR-DISK_DD.20141217_SN.26632-00_DF.NC' #my file
#f ='./files/dmsp/rfe31_PS.APL_V0116S024CE0008_SC.U_DI.A_GP.F17-SSUSI_PA.APL-SDR-DISK_DD.20141217_SN.41889-00_DF.NC' #my file
...
title = 'RFE:31 DMSP F18 and SuperDARN cly 17.12.2014 21:11'
...
sc_time = [dt.datetime(2014, 12, 17) + dt.timedelta(seconds=x) for x in fh.variables['DMSP_COORDS_TIME'].data.ravel()]
...
##Swarm-B
latSwarm,lonSwarm,timeSwarm=satorbit('./files/orbits/31_SW-B.txt')
...
##NOAA-15
lat2,lon2,time2=satorbit('./files/orbits/31_NOAA-15.txt')
...
#Add SuperDARN Scan
#===================================================
sTime=dt.datetime(2014, 12, 17, 21, 11)
...
plt.savefig('./dmsp31_f18.png', dpi=600)
