...
map_date_ = dt.datetime(2014, 12, 18, 21, 43)

f ='./files/dmsp/rfe11_PS.APL_V0116S024CE0018_SC.U_DI.A_GP.F16-SSUSI_PA.APL-SDR-DISK_DD.20141218_SN.57624-00_DF.NC' #my file
...
title = 'DMSP F16 and SuperDARN 18.12.2014 22:17'
...
sc_time = [dt.datetime(2014, 12, 18) + dt.timedelta(seconds=x) for x in fh.variables['DMSP_COORDS_TIME'].data.ravel()]
...
##Swarm
latSwarm,lonSwarm,timeSwarm=satorbit('./files/orbits/11_SW-A.txt')
...
##NOAA-18
lat2,lon2,time2=satorbit('./files/orbits/11_NOAA-18.txt')
...
#Add SuperDARN Scan
#===================================================
sTime=dt.datetime(2014, 12, 18, 22, 17)
...
plt.savefig('./dmsp11_3.png', dpi=600)
