...
map_date_ = dt.datetime(2014, 12, 10, 11, 03)

#f ='./files/dmsp/rfe21_PS.APL_V0116S024CE0008_SC.U_DI.A_GP.F17-SSUSI_PA.APL-SDR-DISK_DD.20141203_SN.41685-00_DF.NC' #my file
f ='./files/dmsp/rfe45_PS.APL_V0116S024CE0008_SC.U_DI.A_GP.F17-SSUSI_PA.APL-SDR-DISK_DD.20141210_SN.41784-00_DF.NC' #my file
...
title = 'RFE:45 DMSP F16 and SuperDARN 11.12.2014 11:03'
...
sc_time = [dt.datetime(2014, 12, 10) + dt.timedelta(seconds=x) for x in fh.variables['DMSP_COORDS_TIME'].data.ravel()]
...
#Add SuperDARN Scan
#===================================================
sTime=dt.datetime(2014, 12, 10, 11, 05)
...
plt.savefig('./dmsp45.png', dpi=600)
