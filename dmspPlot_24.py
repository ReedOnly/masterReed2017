...
title = 'RFE:24 DMSP F18 and SuperDARN 04.12.2014 10:35'
...
sc_time = [dt.datetime(2014, 12, 4) + dt.timedelta(seconds=x) for x in fh.variables['DMSP_COORDS_TIME'].data.ravel()]
...
##NOAA-19
lat2,lon2,time2=satorbit('./files/orbits/24_NOAA-19.txt')
...
#Add SuperDARN Scan
#===================================================
sTime=dt.datetime(2014, 12, 4, 10, 35)
